...
export default function CarbonSurvey() {
    const [currentQuestion, setCurrentQuestion] = useState(
        "Did you use a car/motorcycle yesterday?",
    );
        ...
        switch (question) {
            case "Did you use a car/motorcycle yesterday?":
                return answer === "Yes"
                    ? {
                          nextQuestion:
                              "Did you use the most carbon efficient route?",
                          newSavings: 0,
                      }
                    : {
                          nextQuestion:
                              "Did you use any public transportation?",
                          newSavings: 0,
                      };
            ...
            case "Did you use any public transportation?":
                return {
                    nextQuestion:
                        answer === "Yes"
                            ? null
                            : "Did you use an alternate electric form of transportation?",
                    newSavings: answer === "Yes" ? 14.6 : 0.0,
                };

            case "Did you use an alternate electric form of transportation?":
                return {
                    nextQuestion: null,
                    newSavings: answer === "Yes" ? 27.0 : 30.0,
                };
            ...
            case "Did you use the most carbon efficient route?":
                ...
                return {
                    nextQuestion:
                        "Did you drive at the speed limit to improve mileage?",
                    newSavings: 0.0,
                };
            ...
            case "Did you carpool?":
                ...
                return {
                    nextQuestion: "Was the car/motorcycle electric?",
                    newSavings: 0.0,
                };
    ...
    const handleAnswer = (answer) => {
        ...
        const { nextQuestion, newSavings } = getNextStepAndSavings(
            currentQuestion,
            answer,
        );
        ...
        if (nextQuestion) {
            ...
            addCarbonSaved(newSavings); // Store the value in local storage
            const date = new Date();
            setLastDate(date);
        }
    };
            ...
            {!surveyCompleted ? (
                ...
                <div className="flex flex-col items-center min-h-screen">
                    ...
                    <p className="text-2xl text-gray-700 mt-6">
                        You saved{" "}
                        <span className="font-bold">{savings.toFixed(1)}</span>{" "}
                        lbs of carbon!
                    </p>
